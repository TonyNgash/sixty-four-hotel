// ──────────────────────────────────────────────────────────────
// components/frontend/home-sections/room-categories/category-card.tsx
// ──────────────────────────────────────────────────────────────
...
import { RoomCategory } from '@/lib/home-data/room-categories-data';
    ...
    <div className="group relative bg-white rounded-lg overflow-hidden transition-all duration-300 hover:shadow-2xl">
      ...
      <div className="relative h-64 md:h-72 overflow-hidden">
        <Image
          ...
          loading="lazy"
        />
        {/* Subtle warm glow overlay (hero haze vibe) */}
        <div
