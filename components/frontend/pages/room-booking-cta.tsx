// components/frontend/pages/room-booking-cta.tsx
...
export default function RoomBookingCta({ price, roomId }: RoomBookingCtaProps) {
  return (
    <div className="lg:col-span-1">
      <div className="bg-white rounded-2xl shadow-xl p-8 sticky top-8">
        ...
        <Link href={`/booking?room=${roomId}`} className="block w-full">
          <button className="w-full bg-gradient-to-r from-amber-600 to-orange-600 text-white py-4 rounded-xl font-semibold text-lg hover:from-amber-700 hover:to-orange-700 transition-all transform hover:scale-105 shadow-lg flex items-center justify-center gap-2">
